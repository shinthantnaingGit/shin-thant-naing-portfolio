...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden scroll-smooth">
      ...
      <main className="relative z-10">
        ...
        >
          <Hero messages={t} scrollToSection={scrollToSection} />
          <About messages={t} />
          <Skills messages={t} />
          <Projects messages={t} />
